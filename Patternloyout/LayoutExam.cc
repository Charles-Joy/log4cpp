...
int main(int argc,char* argv[])
{
	...
	infoCategory.fatal("system has a fatal error,must be shutdowm");
	infoCategory.info("system shutdown,you can find some infoCategory in system log");
